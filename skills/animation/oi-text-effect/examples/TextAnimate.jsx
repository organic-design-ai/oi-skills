...
/**
 * TextAnimate
 * Source: magicui.design/docs/components/text-animate (MIT)
 * Re-distributed as part of the `oi-text-effect` skill.
 *
 * Requires: motion >= 11 (https://www.npmjs.com/package/motion)
 *   pnpm add motion
 *
 * `cn` helper expected at `@/lib/utils` (shadcn-style). If you don't have one,
 * replace `cn(...)` with a minimal class-merge (or drop it entirely).
 */
