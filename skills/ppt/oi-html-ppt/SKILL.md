...
name: oi-html-ppt
description: >-
  HTML PPT Studio — static HTML presentations with 36 themes, layouts, animations, presenter
  mode. TRIGGER for presentation, PPT, slides, deck, 幻灯片, 演讲稿, 小红书图文. NOT for
  magazine swipe decks (oi-guizang-ppt) or video/GIF widget tasks.
---
...
Author professional HTML presentations as static files. One theme file = one look. One layout
...
- 「用 product-launch 模板做发布会 deck」
- 「小红书图文风，soft-pastel」

**Do not use for:** horizontal magazine/Swiss swipe decks → `oi-guizang-ppt`; video → GIF → widget skills.

Pure static HTML/CSS/JS (CDN webfonts only). No build step.
