...
name: oi-guizang-ppt
description: >-
  Single-file horizontal HTML PPT: Style A editorial magazine (WebGL + serif) or Style B Swiss
  International (grid + IKB accents). TRIGGER for 杂志风 PPT, 瑞士风, horizontal swipe deck,
  网页幻灯片. NOT for reveal-style multi-file decks (oi-html-ppt).
---
...
- 「瑞士风产品发布，克莱因蓝，带 KPI 和数据页」

**Do not use for:** 大段可编辑表格协作、Reveal 式多文件主题切换 deck → `oi-html-ppt`.
...
1. 同时打开当前模板或生成页、以及同风格的参考 deck（如有）做视觉对照。
