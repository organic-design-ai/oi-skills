...
name: oi-pro-ui
description: >-
  UI/UX design intelligence for landing pages and apps: BM25 search over styles, colors,
  typography, landing patterns, UX rules, charts, and stack guides (html-tailwind, react,
  nextjs, vue, shadcn, etc.). TRIGGER when user wants oi-pro-ui, design-system generation,
  or data-driven UI recommendations. Requires python3 for scripts/search.py.
---
# Oi Pro UI — Design Intelligence
...
**Example prompts**
- 「oi-pro-ui 搜 SaaS dashboard 配色和字体」
- 「用 oi-pro-ui 选 landing page UX 规则」
- 「Next.js + shadcn 的组件模式」

**Do not use for:** ffmpeg; single named aesthetic only → `oi-awesome-ui`; local DESIGN.md loop → `oi-stitch-ui`.
...
- **Stack**: Infer from project (default **html-tailwind** for landing pages; also react, nextjs, vue, svelte as needed)
...
| Stack | Focus |
|-------|-------|
| `html-tailwind` | Layout, a11y, forms, landing sections |
| `react` | Components, hooks, performance |
| `nextjs` | App router, RSC, SEO |
...
- Add `--stack <stack>` matching the project (e.g. html-tailwind, react, nextjs)
