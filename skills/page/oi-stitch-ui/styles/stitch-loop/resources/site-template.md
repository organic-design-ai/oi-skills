...
## 2. Visual Language
*Reference these descriptors when generating UI.*
...
* **Root:** `site/public/`
* **Asset Flow:** The build step produces to `queue/` → Validate → Move to `site/public/`
...
**Project ID:** [Design directory: `design/`
...
## 6. Design System Notes for UI implementation Generation
