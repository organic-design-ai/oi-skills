 ...
 *
 * Usage:
 *   npx tsx snapshot.ts --url http://localhost:5173 --output design/home.html
 *   npx tsx snapshot.ts --url http://localhost:3000/pricing --output design/pricing.html --html-class dark
 *   npx tsx snapshot.ts --url http://localhost:5173 --output design/page.html --wait 5000 --viewport 1440x900
 *
 * Flags:
