...
description: Extract DESIGN.md from frontend source code without building the app.
---
...
**Example prompts**
- 「oi-stitch-ui extract-design-md 跑一遍」
- 「按 extract-design-md 更新 design/DESIGN.md」
...
- User wants to migrate a project's visual identity into the design/ package
...
downstream agents can use to recreate the same visual feel.
...
#### 6. UI Generation Notes

Synthesize the extraction into actionable prompts for UI implementation:
...
`design/DESIGN.md` in the project directory (create the `design/` directory
if it doesn't exist).
...
## 6. Design System Notes for UI Generation
### Language to Use
### Color References
### Component Prompts
...
- [ ] Agent-facing notes use natural language, not raw CSS dumps
