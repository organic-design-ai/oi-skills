...
> **Agent:** If the user asks how to use this skill (`usage`, `怎么用`, `help`, `@output-skill` without a concrete task), **reply with this section** (replace `<skill-dir>` with this skill's install path, e.g. `~/.agents/skills/oi-taste-ui`), then ask what they want to accomplish.
