...
> **Agent:** If the user asks how to use this skill (`usage`, `怎么用`, `help`, `@editorial` without a concrete task), **reply with this section** (replace `<pkg-dir>` with the installed package path, e.g. `~/.agents/skills/oi-skills`), then ask what they want to accomplish.

**Triggers:** Style name **editorial**, or parent **oi-awesome-ui** after slug is chosen.

**Quick start**
1. Parent: `<pkg-dir>/page/oi-awesome-ui/SKILL.md` — confirm slug **editorial**.
2. Read this file + optional `DESIGN.md` in the same folder.
3. Apply tokens, do/don't, and quality gates in the user's codebase.

**What this style is:** Magazine-inspired editorial layout with refined serif typography, structured grids, and elegant reading experiences.

**Example prompts**
- 「用 **editorial** 风格做产品落地页」
- 「按 oi-awesome-ui editorial 设计系统实现 hero + pricing」
- 「检查组件是否符合 editorial tokens」
