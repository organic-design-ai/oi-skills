...
> **Agent:** If the user asks how to use this skill (`usage`, `怎么用`, `help`, `@impeccable` without a concrete task), **reply with this section** (replace `<pkg-dir>` with the installed package path, e.g. `~/.agents/skills/oi-skills`), then ask what they want to accomplish.

**Triggers:** Style name **impeccable**, or parent **oi-awesome-ui** after slug is chosen.

**Quick start**
1. Parent: `<pkg-dir>/page/oi-awesome-ui/SKILL.md` — confirm slug **impeccable**.
2. Read this file + optional `DESIGN.md` in the same folder.
3. Apply tokens, do/don't, and quality gates in the user's codebase.

**What this style is:** "A modern, graphic, editorial-poster aesthetic — warm and confident — built on alternating cream and burnt orange sections, an amber brand color."

**Example prompts**
- 「用 **impeccable** 风格做产品落地页」
- 「按 oi-awesome-ui impeccable 设计系统实现 hero + pricing」
- 「检查组件是否符合 impeccable tokens」
