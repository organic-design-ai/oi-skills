...
**What this style is:** Shadcn/ui-inspired design with minimal, clean components, monochrome palette, and utility-first patterns.

**Example prompts**
- 「用 **shadcn** 风格做产品落地页」
- 「按 oi-awesome-ui shadcn 设计系统实现 hero + pricing」
- 「检查组件是否符合 shadcn tokens」
